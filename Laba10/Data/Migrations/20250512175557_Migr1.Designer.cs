...
namespace Laba10.Migrations
{
    ...
    [Migration("20250512175557_Migr1")]
    partial class Migr1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Laba10.Data.Abonent", b =>
                {
            ...
            modelBuilder.Entity("Laba10.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Laba10.Data.Pokazanie", b =>
                {
            ...
            modelBuilder.Entity("Laba10.Data.Schetchik", b =>
                {
                    b.Property<int>("SchetchikId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Laba10.Data.Pokazanie", b =>
                {
                    b.HasOne("Laba10.Data.Schetchik", "Schetchik")
                        .WithMany("Pokazanie")
            ...
            modelBuilder.Entity("Laba10.Data.Schetchik", b =>
                {
                    b.HasOne("Laba10.Data.Abonent", "Abonent")
                        .WithMany("Schetchiks")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Laba10.Data.ApplicationUser", null)
                        .WithMany()
